...
# Raycast Script: Emacs Org Mode to Google Sheets Sync
# This script parses DONE entries from your org file and uploads them to Google Sheets

# Configuration - Update these paths and IDs
ORG_FILE="INPUT HERE"
